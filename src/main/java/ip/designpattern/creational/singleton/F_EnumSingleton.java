...
/**
 * To overcome breaking of singleton through Reflection, we can use Enum to implement Singleton design pattern 
 * as Java ensures that any enum value is instantiated only once in a Java program. Since Java Enum values are 
